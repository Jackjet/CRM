...
namespace CRM_Model
{
    ...
    public partial class workplan:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(workplan))
            {
                workplan _obj = obj as workplan;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class cust_linkman:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(cust_linkman))
            {
                cust_linkman _obj = obj as cust_linkman;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class cust_customer:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(cust_customer))
            {
                cust_customer _obj = obj as cust_customer;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class crm_log:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(crm_log))
            {
                crm_log _obj = obj as crm_log;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class param_rule:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(param_rule))
            {
                param_rule _obj = obj as param_rule;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class praise:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(praise))
            {
                praise _obj = obj as praise;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class pub_param:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(pub_param))
            {
                pub_param _obj = obj as pub_param;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class remind:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(remind))
            {
                remind _obj = obj as remind;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class follow_up:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(follow_up))
            {
                follow_up _obj = obj as follow_up;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class remind_setting:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(remind_setting))
            {
                remind_setting _obj = obj as remind_setting;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class report_sender:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(report_sender))
            {
                report_sender _obj = obj as report_sender;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class sign_in:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(sign_in))
            {
                sign_in _obj = obj as sign_in;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class statistic:TableBase
    {
          ...
          public override bool Equals(object obj)
        {
            ...
            {
                statistic _obj = obj as statistic;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class statistic_detail:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(statistic_detail))
            {
                statistic_detail _obj = obj as statistic_detail;
                if (_obj.id == this.id)
                {
                    result = true;
                }
    ...
    public partial class Sys_UserInfo:TableBase
    {
          ...
          public override bool Equals(object obj)
        {
            ...
            {
                Sys_UserInfo _obj = obj as Sys_UserInfo;
                if (_obj.Id == this.Id)
                {
                    result = true;
                }
    ...
    public partial class workreport:TableBase
    {
        ...
        {
            bool result = false;
            if (obj.GetType() == typeof(workreport))
            {
                workreport _obj = obj as workreport;
                if (_obj.id == this.id)
                {
                    result = true;
                }
